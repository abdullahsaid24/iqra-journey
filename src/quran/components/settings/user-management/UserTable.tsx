...
import { Dialog, DialogContent, DialogDescription, DialogHeader, DialogTitle } from "@/quran/components/ui/dialog";
import { Input } from "@/quran/components/ui/input";
import { Label } from "@/quran/components/ui/label";
import { Form, FormControl, FormDescription, FormField, FormItem, FormLabel, FormMessage } from "@/quran/components/ui/form";
import { z } from "zod";
...
import { UserRole } from "@/quran/components/settings/user-management/CreateUserFormState";
          ...
          <TableBody>
            {filteredUsers.length > 0 ? filteredUsers.map((user) => (
              <TableRow key={user.id} className="hover:bg-slate-50">
                ...
                <TableCell className="capitalize text-slate-600">{user.role}</TableCell>
