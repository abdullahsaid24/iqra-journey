...
export const StudentLevelsReset = () => {
  ...
  return <Card className="p-6">
      <div className="space-y-4">
        <div>
          <h3 className="text-lg font-semibold text-neutral-50">Reset Student Levels</h3>
          <p className="text-sm text-gray-600 mt-1">
            Reset all students' absence and failure levels to 1. This action will affect all students in the system.
          </p>
        </div>
        
        <Button onClick={handleReset} disabled={isResetting} variant="outline" className="flex items-center gap-2">
