...
import { StudentSelectionDialog } from "@/components/settings/user-management/StudentSelectionDialog";
import { useStudents } from "@/components/settings/user-management/hooks/useStudents";
  ...
  return <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
      <div>
        <div className="flex items-center gap-2 mb-2">
          <Button variant="ghost" className="text-white hover:text-quran-primary" onClick={() => navigate('/dashboard')}>
