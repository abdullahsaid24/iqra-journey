        ...
        <div className="space-y-4">
          ...
          <div className="bg-gray-50 p-3 rounded-lg">
            <div className="flex items-center justify-between">
              ...
              {recipientData && recipientData.count > 0 && <Button variant="ghost" size="sm" onClick={() => setShowRecipients(!showRecipients)}>
            ...
            {showRecipients && recipientData && <div className="mt-3 max-h-32 overflow-y-auto">
                <div className="space-y-1">
                  {recipientData.recipients.map((recipient, index) => <div key={index} className="text-xs text-gray-600 flex justify-between">
          ...
          <div>
            ...
            <Textarea id="message" value={message} onChange={e => setMessage(e.target.value)} placeholder="Enter your message to send to all parents and adult students in this class..." rows={6} className="resize-none" />
          ...
          <div className="flex justify-end gap-2">
            ...
            <Button onClick={handleSendMessage} disabled={isSending || !message.trim() || (recipientData?.count || 0) === 0}>
              {isSending ? <>
